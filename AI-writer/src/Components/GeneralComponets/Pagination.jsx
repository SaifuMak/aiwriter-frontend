        ...
        <div className="flex justify-end px-8 my-8 space-x-4 ">
            <div className="flex justify-between w-7/12">
                <div className="space-x-2 ">
                    ...
                    <button onClick={() => function_to_call(nextPage)} disabled={nextPage == null} className={`px-6 py-1 text-white rounded-md ${nextPage ? ' bg-custom-dark-orange' : 'bg-custom-dark-orange opacity-40'} `}>next</button>
                </div>
