...
function CardComponent({title, description, buttonText, LinkTo,FunctionToCall, buttonAction, footer}) {
    ...
    <div className="">
        <Link to={LinkTo}  className="px-10 py-1 text-center text-white rounded-md max-xl:text-sm xl:py-2 xl:px-16 hover:bg-hover-button-color bg-custom-dark-orange">{buttonText}</Link>
    </div>
