                ...
                <div className="w-full h-screen px-6 py-10 md:px-8 xl:px-12 lg:w-10/12">
                    <div className="flex ">
                        ...
                        <div className="flex p-1.5 ml-6 rounded-md  w-42 bg-custom-light-orange">
                            <button onClick={() => handleToggle('Article')} className={`px-2 py-1  cursor-pointer tracking-wider ${SelectedTab === 'Article' ? 'bg-custom-dark-orange font-semibold text-white  rounded-md' : ''}   `}>Content</button>
                    ...
                    <div className="flex items-center justify-between w-full mt-10 space-x-20 ">
                        <div ref={dropdownref} className="w-2/12">
